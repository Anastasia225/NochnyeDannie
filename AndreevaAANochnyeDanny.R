# јндреева јнастаси€ јлександровна - дл€ ночных данных за осень 2019 года, 
постройте регрессионную зависимость скорости сокотечени€ (переменна€ Flux) дл€ деревьев вида Larix sibirica
