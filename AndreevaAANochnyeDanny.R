# Андреева Анастасия Александровна - для ночных данных за лето 2019 года, постройте регрессионную зависимость скорости сокотечения (переменная Flux) для деревьев с визуальной оценкой выше 3
...
data_filtered_3=data_filtered_3[ ,-c("id", "Species","age_group_index","time", "antrop_load", 
                                     "in_site_antrop_load")]
library(dplyr)
